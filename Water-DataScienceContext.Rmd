...
In my Data Science in Context presentation, I only used some of the graphs produced here. I also only included graphs with complete sets of data. Any missing values were not used. In the simplified data sets, E stood for estimated data, and I stood for imputed data.
